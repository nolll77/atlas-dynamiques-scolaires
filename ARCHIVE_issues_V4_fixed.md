...
- **Synopsis du Chapitre (Réflexions de l'Auteur) :**
  - **Note éthique Tome II** : la position d'un lycée dans le réseau (centralité, communauté, rôle de pont) est une propriété émergente du traitement analytique, non une caractéristique intrinsèque.
  - **Avant-propos du Tome II** : transition "du territoire au réseau". Formulation obligatoire : *"Les liens dans le réseau représentent des similarités de composition sociale, non des flux réels d'élèves sauf mention explicite."*
  - Nœuds, liens, poids : transposer la réalité scolaire en graphe.
  - La similarité sociale comme lien latent.
  - *Nouveauté* : justification formelle de la fonction de similarité choisie vs alternatives (Jaccard, cosinus).
...
- **Synopsis du Chapitre (Réflexions de l'Auteur) :**
  - **Note éthique et épistémologique Tome III — VERSION RENFORCÉE** :
  - **Avant-propos du Tome III** : transition "du réseau aux dynamiques". Présentation des données longitudinales. Note de limitation explicite : *"Les séries temporelles couvrent [N années] d'observations agrégées. Cette granularité ne permet pas l'identification causale forte ni la modélisation individuelle."*
  - Le système scolaire comme processus, pas comme état.
  - Trois questions : comment évolue-t-il, pourquoi, peut-on le changer ?
  - *Nouveauté* : présentation transparente du dataset longitudinal construit (qualité des séries, années manquantes, biais de sélection temporels).
- **Artefacts générés** : Annexe A7.
